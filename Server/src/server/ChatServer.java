...
public class ChatServer {
	...
	public static ArrayList<ArrayList<Socket>> ClientRoomSocketList = new ArrayList<ArrayList<Socket>>();
	...
	public static int[] ThreadFlag = new int[100];
				...
				while(true)
				{
					...
					if(IGameType ==1) {
						...
						if(RoomCountToEx == -1) {
							...
							ClientRoomSocketList.get(RoomCountToEx).add(c_socket);
