...
public class WaitingRoom extends JFrame{
	...
	public WaitingRoom() {
		...
		P1_Label.setFont(new Font("Default_SC", Font.PLAIN, 30));
		...
		P2_Label.setFont(new Font("Default_SC", Font.PLAIN, 30));
		...
		P3_Label.setFont(new Font("Default_SC", Font.PLAIN, 30));
		...
		P4_Label.setFont(new Font("Default_SC", Font.PLAIN, 30));
