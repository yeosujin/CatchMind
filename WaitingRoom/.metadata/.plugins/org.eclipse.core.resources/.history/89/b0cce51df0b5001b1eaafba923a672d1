...
public class ChooseType extends JDialog {
	...
	public ChooseType(Window parent) {
		...
		setNickname.setFont(new Font("Default_SC", Font.PLAIN, 30));
		...
		JoinRoomButton.setFont(new Font("Default_SC", Font.PLAIN, 40));
		CreateRoomButtonLang.setFont(new Font("Default_SC", Font.PLAIN, 20));
		JoinRoomButtonLang.setFont(new Font("Default_SC", Font.PLAIN, 20));
		JoinRoomButtonLang2.setFont(new Font("Default_SC", Font.PLAIN, 20));
		setYourNickname.setFont(new Font("Default_SC", Font.PLAIN, 30));
		setYourNickname2.setFont(new Font("Default_SC", Font.PLAIN, 25));
